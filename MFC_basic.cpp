...
#pragma comment ( lib, "gdi32.lib" ) //在"Settings->Compiler->Linker Settings->Other Linker Options"添加-mwindows
//全局变量
HINSTANCE hinst;
//函数声明
    ...
    int nCmdShow)
{
    ...
    wcx.style = CS_HREDRAW | CS_VREDRAW;                        //样式:大小改变时重回界面
    ...
    wcx.hbrBackground = (HBRUSH) ( WHITE_BRUSH ); //背景:白色
